...
public class StringSourceJavaFileObject extends SimpleJavaFileObject {
    ...
    /**
     * The package name extracted from the source's {@code package} declaration.
    ...
    /**
     * The fully-qualified binary name (e.g. {@code "com.example.Foo"}).
     * Derived from the package declaration and the URI file name.
     */
