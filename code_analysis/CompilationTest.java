...
public class CompilationTest {
  ...
  void emptyCompilation() {
    assertThrows(IllegalArgumentException.class, () -> Compilation.create(List.of()));
  }
    ...
    var sources =
        List.of(
            ...
            SourceText.of(
                ...
                "package com.example; public class Derived extends Base { public int doubled() {"
                    + " return value * 2; } }"));
  ...
  void semanticModelResolvesTypes() {
    var source =
        SourceText.of("TypeCheck.java", "class TypeCheck { java.util.List<String> items; }");
  ...
  void compilerOptionsClassPath() {
    var options = CompilerOptions.builder().flag("-Xlint:deprecation").build();
