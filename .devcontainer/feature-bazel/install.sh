...
if [[ $ARCH == "arm64" ]]; then
    curl https://github.com/bazelbuild/bazelisk/releases/download/v1.24.1/bazelisk-linux-arm64 -Lo /usr/local/bin/bazel
    ...
    curl https://github.com/withered-magic/starpls/releases/download/v0.1.19/starpls-linux-aarch64 -Lo /usr/local/bin/starpls
    curl https://github.com/pnpm/pnpm/releases/download/v9.14.4/pnpm-linux-arm64 -Lo /usr/local/bin/pnpm
elif [[ $ARCH == "x86_64" ]]; then
    curl https://github.com/bazelbuild/bazelisk/releases/download/v1.24.1/bazelisk-linux-amd64 -Lo /usr/local/bin/bazel
    ...
    curl https://github.com/withered-magic/starpls/releases/download/v0.1.19/starpls-linux-amd64 -Lo /usr/local/bin/starpls
    curl https://github.com/pnpm/pnpm/releases/download/v9.14.4/pnpm-linux-x64 -Lo /usr/local/bin/pnpm
else
