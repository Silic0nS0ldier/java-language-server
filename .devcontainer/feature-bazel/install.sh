...
if [[ $ARCH == "arm64" ]]; then
    ...
    curl https://github.com/pnpm/pnpm/releases/download/v9.4.0/pnpm-linux-arm64 -Lo /usr/local/bin/pnpm
    ...
    curl https://github.com/pnpm/pnpm/releases/download/v9.4.0/pnpm-linux-x64 -Lo /usr/local/bin/pnpm
