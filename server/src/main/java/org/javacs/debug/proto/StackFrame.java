...
public class StackFrame {
  /**
   * An identifier for the stack frame. It must be unique across all threads. This id can be used to
   * retrieve the scopes of the frame with the 'scopesRequest' or to restart the execution of a
   * stackframe.
   */
  public long id;
   ...
   * value of 'subtle' can be used to change the appearance of a frame in a 'subtle' way. 'normal' |
   * 'label' | 'subtle'.
   */
