...
public class ProcessEventBody {
  ...
  /**
   * Describes how the debug engine started debugging this process. 'launch': Process was launched
   * under the debugger. 'attach': Debugger attached to an existing process.
  ...
  /**
   * The size of a pointer or address for this process, in bits. This value may be used by clients
   * when formatting addresses for display.
   */
