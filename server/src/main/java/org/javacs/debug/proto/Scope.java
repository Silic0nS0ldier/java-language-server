...
public class Scope {
  /**
   * Name of the scope such as 'Arguments', 'Locals', or 'Registers'. This string is shown in the UI
   ...
   * 'locals': Scope contains local variables. 'registers': Scope contains registers. Only a single
   * 'registers' scope should be returned from a 'scopes' request. etc.
   */
  ...
  /**
   * The number of indexed variables in this scope. The client can use this optional information to
   * present the variables in a paged UI and fetch them in chunks.
   */
