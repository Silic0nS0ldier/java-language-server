...
public class EvaluateResponseBody {
  ...
  /**
   * Properties of a evaluate result that can be used to determine how to render the result in the
   * UI.
   */
  ...
  /**
   * The number of indexed child variables. The client can use this optional information to present
   * the variables in a paged UI and fetch them in chunks.
   */
  public Integer indexedVariables;

  /**
   * Memory reference to a location appropriate for this result. For pointer type eval results, this
   * is generally a reference to the memory address contained in the pointer.
   */
