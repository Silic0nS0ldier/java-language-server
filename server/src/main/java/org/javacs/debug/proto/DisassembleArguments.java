...
public class DisassembleArguments {
  ...
  /**
   * Optional offset (in bytes) to be applied to the reference location before disassembling. Can be
   * negative.
   */
  ...
  /**
   * Number of instructions to disassemble starting at the specified location and offset. An adapter
   * must return exactly this number of instructions - any unavailable instructions should be
