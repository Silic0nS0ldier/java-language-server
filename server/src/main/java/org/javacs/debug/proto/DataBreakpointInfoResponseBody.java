...
public class DataBreakpointInfoResponseBody {
  ...
  /**
   * UI string that describes on what data the breakpoint is set on or why a data breakpoint is not
   * available.
   */
   ...
   * frontend could surface this information. 'read' | 'write' | 'readWrite'.
   */
