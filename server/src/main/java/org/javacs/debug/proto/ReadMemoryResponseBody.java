...
public class ReadMemoryResponseBody {
  ...
  /**
   * The number of unreadable bytes encountered after the last successfully read byte. This can be
   * used to determine the number of bytes that must be skipped before a subsequent 'readMemory'
