...
public class DebugAdapter {
        ...
        try {
          ...
          switch (msg.type) {
            ...
            case "event":
              ...
              break;
            case "response":
              // Process responses on the reader thread (which will usually wake up the main thread
              // via a
              // CompletableFuture)
  ...
  public DebugAdapter(
      Function<DebugClient, DebugServer> serverFactory, InputStream receive, OutputStream send) {
