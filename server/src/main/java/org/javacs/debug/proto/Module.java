 ...
 *
 * <p>Additional attributes can be added to the module. They will show up in the module View if they
 * have a corresponding ColumnDescriptor.
 *
 * <p>To avoid an unnecessary proliferation of additional attributes with similar semantics but
...
public class Module {
   ...
   *
   * <p>Logical full path to the module. The exact definition is implementation defined, but usually
