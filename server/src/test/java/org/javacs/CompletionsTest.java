...
public class CompletionsTest extends CompletionsBase {
  ...
  public void member() {
    ...
    String[] virtuals = {
      "testFields", "testMethods", "testFieldsPrivate", "testMethodsPrivate", "getClass"
    };
    assertThat("includes non-static members", suggestions, hasItems(virtuals));
    assertThat(
        "excludes constructors", suggestions, not(hasItem(startsWith("AutocompleteMember"))));
  }
  ...
  public void fieldFromInitBlock() {
    ...
    assertThat(
        suggestions, hasItems("testFields", "testFieldStatic", "testMethods", "testMethodStatic"));
  }
  ...
  public void fieldFromMethod() {
    ...
    String[] expect = {
      "testFields", "testFieldStatic", "testMethods", "testMethodStatic", "testArguments"
    };
    assertThat(suggestions, hasItems(expect));
  }
  ...
  public void importClass() {
    ...
    // For performance, we assume OtherPackagePrivate.java contains a public class
    // OtherPackagePrivate
  ...
  public void enumConstantFromClassPath() {
    ...
    assertThat(
        "suggests enum options",
        suggestions,
        containsInAnyOrder("FULL", "LONG", "MEDIUM", "SHORT"));
  }
