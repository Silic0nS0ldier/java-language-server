...
public class SourceFileManagerTest {
  ...
  static final Path classes =
      LanguageServerFixture.DEFAULT_WORKSPACE_ROOT.resolve("target/classes");
  ...
  //                     StandardLocation.SOURCE_PATH, "com.example.PackagePrivate",
  // JavaFileObject.Kind.SOURCE);
  //     var standardClass =
  //             standardFileManager.getJavaFileForInput(
  //                     StandardLocation.CLASS_PATH, "com.example.PackagePrivate",
  ...
  //                     StandardLocation.CLASS_PATH, "com.example.PackagePrivate",
  // JavaFileObject.Kind.CLASS);
  //     var standardJavaName = standardFileManager.inferBinaryName(StandardLocation.SOURCE_PATH,
  // standardJava);
  //     var standardClassName = standardFileManager.inferBinaryName(StandardLocation.CLASS_PATH,
  // standardClass);
  //     var sourceJavaName = sourceFileManager.inferBinaryName(StandardLocation.SOURCE_PATH,
  // sourceJava);
  //     var sourceClassName = sourceFileManager.inferBinaryName(StandardLocation.CLASS_PATH,
  // sourceClass);
