...
public class CodeActionTest {
  ...
  private static final JavaLanguageServer server =
      LanguageServerFixture.getJavaLanguageServer(errors::add);
  ...
  public void testConvertToStatement() {
    assertThat(
        quickFix("org/javacs/action/TestConvertToStatement.java"),
        contains("Convert to statement"));
  }
  ...
  public void testSuppressWarning() {
    assertThat(
        quickFix("org/javacs/action/TestSuppressWarning.java"),
        contains("Suppress 'unchecked' warning"));
  }
  ...
  public void testRemoveNotThrown() {
    assertThat(
        quickFix("org/javacs/action/TestRemoveNotThrown.java"), contains("Remove 'IOException'"));
  }

  @Test
  public void testGenerateConstructor() {
    assertThat(
        quickFix("org/javacs/action/TestGenerateConstructor.java"),
        contains("Generate constructor"));
  }

  @Test
  public void testDontGenerateConstructor() {
    assertThat(
        quickFix("org/javacs/action/TestDontGenerateConstructor.java"),
        not(hasItem("Generate constructor")));
  }

  @Test
  public void testImplementAbstractMethods() {
    assertThat(
        quickFix("org/javacs/action/TestImplementAbstractMethods.java"),
        hasItem("Implement abstract methods"));
  }
  ...
  public void testCreateMissingMethod() {
    assertThat(
        quickFix("org/javacs/action/TestCreateMissingMethod.java"),
