...
public class SemanticColorsTest {
  ...
  public void colorType() {
    ...
    assertThat(
        "ignores method parameter declaration", found, not(hasItem("methodParameter:10:field")));
    assertThat(
        "ignores method parameter reference", found, not(hasItem("methodParameter:11:field")));
