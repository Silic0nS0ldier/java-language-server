...
public class GotoTest {
  ...
  public void gotoMismatchedMethod() {
    ...
    assertThat(
        doGoto(file, 5, 12, false),
        hasItems("GotoMismatchedMethod.java:7", "GotoMismatchedMethod.java:8"));
  }

  @Test
  public void packagePrivate() {
    // There is a separate bug where javac doesn't find package-private classes in files with
    // different names.
